...
geometry, MuJoCo introduced `Model Editing <https://mujoco.readthedocs.io/en/3.7.0/programming/modeledit.html>`_.
...
==============================
MuJoCo supports `default classes <https://mujoco.readthedocs.io/en/3.7.0/XMLreference.html#default>`_,
