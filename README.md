# MuJoCo-rs
[![Guide](https://img.shields.io/badge/Guide-book-white)](https://mujoco-rs.readthedocs.io/en/v6.1.x/)
[![docs.rs](https://img.shields.io/docsrs/mujoco-rs/6.1.0)](https://docs.rs/mujoco-rs/6.1.0/mujoco_rs/)
...
> [!IMPORTANT]
> **Upgrading from 5.x to 6.x?** The 6.0.0 release updated MuJoCo to 3.12.0.
> Read the [migration guide](https://mujoco-rs.readthedocs.io/en/v6.1.x/migration.html)
> before upgrading.
...
- [**API docs**](https://docs.rs/mujoco-rs/6.1.0/mujoco_rs/)
- [**Guide book**](https://mujoco-rs.readthedocs.io/en/v6.1.x/)
...
## Installation
For installation, see the [**guide book**](https://mujoco-rs.readthedocs.io/en/v6.1.x/installation.html).
...
[``examples/``](https://github.com/davidhozic/mujoco-rs/tree/v6.1.x/examples) directory.
